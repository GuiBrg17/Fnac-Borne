...
export const UI = {
  fr: {
    ...
    otherStore: "Ces produits sont disponibles à la Fnac Variétés, à l'adresse indiquée à l'écran. Un vendeur d'ici peut aussi vous les commander.",
  ...
  en: {
    ...
    otherStore: "Those are available at Fnac Variétés — the address is on the screen. A staff member here can also order them for you.",
  ...
  es: {
    ...
    otherStore: "Esos productos están en la Fnac Variétés, en la dirección que ve en pantalla. Un vendedor de aquí también puede encargárselos.",
